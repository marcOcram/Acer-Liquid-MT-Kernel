...
enum {
	ACER_SMSM_PROC_CMD_SD_UPDATE = 0x0,		/* acer_sddl_cmd_type */
	ACER_SMEM_PROC_CMD_CHG_RESET,			/* No parameter */
	ACER_SMEM_PROC_CMD_CHG_PWR_OFF,			/* No parameter */
	ACER_SMEM_PROC_CMD_HW_CTRL_VIBRATOR,		/* Vibrator delay */
	...
	ACER_SMSM_PROC_CMD_SET_DETECT_USB,
	ACER_SMEM_PROC_CMD_OS_RAM_DUMP,
#endif
