...
/*eason add for choose E/G sensors*/
static int	m_sensor;
...
config_ctrl_reg(ms1, AK8975_REG_CNTL);
...
//  char *pbuffer = 0;
	...
	switch (cmd) {
		...
		break;
		/*eason add for choose E/G sensors*/
		case ECS_IOCTL_GET_SENSORS:
			sel_sen = m_sensor;
			if (copy_to_user(argp, &sel_sen, sizeof(sel_sen))){
				return -EFAULT;
			}
		break;
                  ...
                  const struct i2c_device_id *devid)
{
	...
	INIT_WORK(&akm->work, akm_work_func);/*enable I2C-->IRQ*/
