...
/* To avoid the inaccuracy, we dont save the time delta in suspend.
 * Keeping time in rtc and tolerate the inaccuracy of one second
 */
...
#endif //defined(CONFIG_PM) && defined(CONFIG_RTC_HCTOSYS_DEVICE)
